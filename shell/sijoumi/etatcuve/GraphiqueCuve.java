...
jl2.setIcon(ICON_TEMP);
    ...
    this.gs.setPreferredSize(new Dimension(150, 150));
    this.gs.setMinimumSize(new Dimension(150, 150));
    ...
    this.progressBarSSP_2.setPreferredSize(new Dimension(132, 68));
    ...
    gc.anchor = 20;
    JLabel jl13 = new JLabel(spaces);
    content6GASOIL3.add(jl13);
    gc.anchor = 26;
  ...
  public void initialisercuveSSP() {
    ...
    this.TempCuveSSP = new JLabel("Temp°:");
    ...
    this.capacite_labelssp = new JLabel("Capacité:");
  ...
  public void initialisercuveGASOIL2() {
    ...
    this.TempCuveG2 = new JLabel("Temp°:");
    ...
    this.capacite_labelg2 = new JLabel("Capacité:");
  ...
  public void initialisercuveGASOIL1() {
    ...
    this.capacite_labelg1 = new JLabel("Capacité:");
  ...
  public void initialisercuvePET() {
    ...
    this.capacite_labelPET = new JLabel("Capacité:");
  ...
  public void initialisercuveG50() {
    ...
    this.capacite_labelG50 = new JLabel("Capacité:");
  ...
  public void initialisercuveSSP2() {
    ...
    this.TempCuveSSP2 = new JLabel("Temp°:");
    ...
    this.capacite_labelSSP2 = new JLabel("Capacité:");
